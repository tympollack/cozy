/**
 * Shared challenge types and default presets.
 * This is a plain module (no 'use server') so it can be imported
...
/**
 * Default preset positive weekly challenges shown when no DB challenge exists.
 */
