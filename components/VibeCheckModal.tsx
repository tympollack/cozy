    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-md rounded-3xl bg-amber-50/95 border-2 border-amber-200/60 shadow-2xl p-6 relative overflow-hidden my-auto max-h-[90vh] flex flex-col justify-between"
          style={{
        ...
        >
          <div>
            ...
            {/* Main prompt */}
            <div className="my-3 p-3.5 rounded-2xl bg-white/70 border border-amber-200/50 text-center shadow-inner">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {isSelected && (
                          <span className="text-[9px] font-800 px-2 py-0.5 rounded-full bg-white/80 text-amber-900 border">
                            Active
                          </span>
                        )}
                      </div>
          ...
          <AnimatePresence>
            {confirmationMsg && (
              <motion.div
                ...
                exit={{ opacity: 0 }}
                className="mt-2 p-3 rounded-xl bg-amber-100/90 border border-amber-300 text-amber-950 text-xs font-700 text-center flex items-center justify-center gap-1.5 shadow-md"
              >
