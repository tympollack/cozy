...
export const SHELL_DEFINITIONS: Record<string, ShellDefinition> = {
  default_dollhouse: {
    ...
    slots: [
      { id: 'room_top_left', label: 'Attic Bedroom', icon: '🛏️', x: 8, y: 16, w: 40, h: 36 },
      { id: 'room_top_right', label: 'Sunroom Studio', icon: '🎨', x: 52, y: 16, w: 40, h: 36 },
      { id: 'room_bottom_left', label: 'Warm Living Room', icon: '🛋️', x: 8, y: 56, w: 40, h: 36 },
      { id: 'room_bottom_right', label: 'Kitchen & Nook', icon: '☕', x: 52, y: 56, w: 40, h: 36 },
    ],
  },
  cozy_campsite: {
    id: 'cozy_campsite',
    ...
    slots: [
      { id: 'spot_tent', label: 'Starlight Tent', icon: '⛺', x: 8, y: 16, w: 40, h: 36 },
      { id: 'spot_campfire', label: 'Campfire Hearth', icon: '🔥', x: 52, y: 16, w: 40, h: 36 },
      { id: 'spot_hammock', label: 'Pine Hammock', icon: '🌲', x: 8, y: 56, w: 40, h: 36 },
      { id: 'spot_overlook', label: 'Mountain Overlook', icon: '⛰️', x: 52, y: 56, w: 40, h: 36 },
    ],
  },
  stone_castle: {
    id: 'stone_castle',
    ...
    slots: [
      { id: 'keep_tower', label: 'Astral Tower', icon: '🔮', x: 8, y: 16, w: 40, h: 36 },
      { id: 'keep_library', label: 'Ancient Library', icon: '📜', x: 52, y: 16, w: 40, h: 36 },
      { id: 'keep_hall', label: 'Great Hearth Hall', icon: '🛡️', x: 8, y: 56, w: 40, h: 36 },
      { id: 'keep_garden', label: 'Cloister Garden', icon: '🌿', x: 52, y: 56, w: 40, h: 36 },
    ],
  },
};
