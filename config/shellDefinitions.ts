...
export const SHELL_DEFINITIONS: Record<string, ShellDefinition> = {
  default_dollhouse: {
    ...
    interiorImage: '/images/interiors/cottage.jpg',
    themeTier: 1,
    slots: [
      { id: 'room_top_left',     label: 'Cozy Corner',      icon: '🛏️', x: 26, y: 26, w: 28, h: 28, tier: 1 },
      { id: 'room_top_right',    label: 'Sunroom Studio',   icon: '🎨', x: 74, y: 26, w: 28, h: 28, tier: 2 },
      { id: 'room_bottom_left',  label: 'Warm Living Room', icon: '🛋️', x: 26, y: 72, w: 28, h: 28, tier: 3 },
      { id: 'room_bottom_right', label: 'Kitchen & Nook',   icon: '☕', x: 74, y: 72, w: 28, h: 28, tier: 3 },
    ],
  },
  cozy_campsite: {
    id: 'cozy_campsite',
    ...
    interiorImage: '/images/interiors/campsite.jpg',
    themeTier: 2,
    slots: [
      { id: 'spot_tent',      label: 'Starlight Tent',    icon: '⛺', x: 22, y: 24, w: 28, h: 28, tier: 1 },
      { id: 'spot_campfire',  label: 'Campfire Hearth',   icon: '🔥', x: 74, y: 26, w: 28, h: 28, tier: 2 },
      { id: 'spot_hammock',   label: 'Pine Hammock',      icon: '🌲', x: 24, y: 74, w: 28, h: 28, tier: 3 },
      { id: 'spot_overlook',  label: 'Mountain Overlook', icon: '⛰️', x: 78, y: 76, w: 28, h: 28, tier: 3 },
    ],
  },
  stone_castle: {
    id: 'stone_castle',
    ...
    interiorImage: '/images/interiors/castle.jpg',
    themeTier: 2,
    slots: [
      { id: 'keep_tower',   label: 'Astral Tower',      icon: '🔮', x: 26, y: 26, w: 28, h: 28, tier: 1 },
      { id: 'keep_library', label: 'Ancient Library',   icon: '📜', x: 74, y: 26, w: 28, h: 28, tier: 2 },
      { id: 'keep_hall',    label: 'Great Hearth Hall', icon: '🛡️', x: 26, y: 74, w: 28, h: 28, tier: 3 },
      { id: 'keep_garden',  label: 'Cloister Garden',  icon: '🌿', x: 74, y: 74, w: 28, h: 28, tier: 3 },
    ],
  },
};
